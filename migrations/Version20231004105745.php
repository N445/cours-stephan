 ...
 */
final class Version20231004105745 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart ADD method_payment VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE payment CHANGE details details LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE payment CHANGE details details LONGTEXT NOT NULL COLLATE `utf8mb4_bin`');
        ...
        $this->addSql('ALTER TABLE cart DROP method_payment');
